...
private:
    ...
    void CreateStructuredPointCloud() {
        ...
        std::cout << "Circle 1 (left): " << circle1_indices_.size() << " points" << std::endl;
        std::cout << "Circle 2 (right): " << circle2_indices_.size() << " points" << std::endl;
        std::cout << "Circle 3 (front): " << circle3_indices_.size() << " points" << std::endl;
        std::cout << "Center points: " << center_indices_.size() << " points" << std::endl;
    }
    ...
    void SetupLayers() {
        ...
        if (layer1) {
            ...
            layer1->SetPointSizeMultiplier(1.5f);
        ...
        if (layer2) {
            ...
            layer2->SetPointSizeMultiplier(1.5f);
            layer2->SetHighlightMode(PointLayer::HighlightMode::kColorAndSize);
        ...
        if (layer3) {
            ...
            layer3->SetPointSizeMultiplier(1.5f);
            layer3->SetHighlightMode(PointLayer::HighlightMode::kColorAndSize);
        ...
        // Find points in overlapping regions (simplified - just take some from each circle)
        for (int i = 40; i < 60; ++i) {
            if (i < circle1_indices_.size()) overlap_indices.push_back(circle1_indices_[i]);
            if (i < circle2_indices_.size()) overlap_indices.push_back(circle2_indices_[i]);
            if (i < circle3_indices_.size()) overlap_indices.push_back(circle3_indices_[i]);
        }
...
int main() {
    try {
        ...
        std::cout << "This demo shows how the multi-layer rendering system works" << std::endl;
