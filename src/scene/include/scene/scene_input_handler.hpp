...
#ifndef SCENE_SCENE_INPUT_HANDLER_HPP
#define SCENE_SCENE_INPUT_HANDLER_HPP
...
#include "scene/camera_control_config.hpp"
 ...
 * 
 * Bridges viewer's InputEventHandler system with scene's 3D-specific
...
#endif  // SCENE_SCENE_INPUT_HANDLER_HPP