# Input Handling System for gldraw

This directory contains a comprehensive input handling system for the gldraw module, providing flexible and extensible user interaction capabilities.
...
```cpp
#include "gldraw/gui/gl_input_handler.hpp"
#include "gldraw/input/camera_interaction_mode.hpp"
#include "gldraw/input/selection_interaction_mode.hpp"
